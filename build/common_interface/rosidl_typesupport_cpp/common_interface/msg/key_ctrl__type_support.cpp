...
static const _KeyCtrl_type_support_symbol_names_t _KeyCtrl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_interface, msg, KeyCtrl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, common_interface, msg, KeyCtrl)),
  }
};
...
{
  return &::common_interface::msg::rosidl_typesupport_cpp::KeyCtrl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, common_interface, msg, KeyCtrl)() {
  return get_message_type_support_handle<common_interface::msg::KeyCtrl>();
}
