...
{
  new (message_memory) common_interface::msg::SerComStruct(_init);
}

void SerComStruct_fini_function(void * message_memory)
{
  auto typed_message = static_cast<common_interface::msg::SerComStruct *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SerComStruct_message_member_array[5] = {
  {
    ...
    offsetof(common_interface::msg::SerComStruct, pwm_l),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(common_interface::msg::SerComStruct, pwm_r),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(common_interface::msg::SerComStruct, dir_l),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(common_interface::msg::SerComStruct, dir_r),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(common_interface::msg::SerComStruct, gear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SerComStruct_message_members = {
  ...
  5,  // number of fields
  sizeof(common_interface::msg::SerComStruct),
...
{
  return &::common_interface::msg::rosidl_typesupport_introspection_cpp::SerComStruct_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, common_interface, msg, SerComStruct)() {
  return &::common_interface::msg::rosidl_typesupport_introspection_cpp::SerComStruct_message_type_support_handle;
}
